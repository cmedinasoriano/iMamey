...
export default class Calendar extends Component {
  ...
  selectAndJumpToToday() {
    ...
    const newMoment = moment(this.state.currentMonthMoment).set('month', today.month());
    this.setState({
  ...
  render() {
    ...
    const numOfWeeks = 6;//getNumberOfWeeks(this.state.currentMonthMoment, this.props.weekStart);
